...
<body style="overflow-y: hidden;">	
        ...
        <div class="ms-top-menu">
            <div class="btn-group" role="group" aria-label="..." style="float:right;">
                ...
                <div class="ms-top-menuchild">
                    ...
                    <!--退出-->
                    <!--a class="ms-top-menuchildtext ms-update" data-toggle="tooltip" data-placement="bottom" title="检查更新"><span class="glyphicon glyphicon-refresh"></span><span class="badge">4</span></a-->
                    <!--更新-->
    ...
    <div class="ms-content" style="padding: 40px 0 0 0;">
		...
		<@ms.modal modalName="editLoginPassword" title="修改密码" style="width:500px">
			  <@ms.modalBody>
			  		<@ms.form  isvalidation=true name="updatePasswordFrom"  action="${base}/manager/updatePassword.do">
